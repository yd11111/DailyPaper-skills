...
**措辞与证据意识：精读笔记要接近 reviewer 水准。**

措辞：
- [ ] 全文无"碾压/全面SOTA/绝对领先/革命性/突破性"等绝对化措辞？
- [ ] 论文 claim 与笔记作者判断用 `Paper Claim` / `My Assessment` 分开？
- [ ] 不确定的判断使用"可能/疑似/需要看全文确认"等措辞？

证据：
- [ ] 方法段有 2-3 句领域定位（与哪类范式同类、novelty 在哪）？
- [ ] 方法段对核心设计解释了 why（不只复述 what）？
- [ ] 实验段末尾有"结果可信度"分层表（高/中/低）？
- [ ] 批判性思考段有 Paper Claim vs My Assessment 审查？
